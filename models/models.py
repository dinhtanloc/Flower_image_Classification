...
def InceptionV3(include_top=True,
    ...
    x = Concatenate(axis=channel_axis,
        name='mixed1')([branch1x1, branch5x5, branch3x3dbl, branch_pool])
    ...
    branch_pool = conv2d_bn(branch_pool, 64, 1, 1)
    x = Concatenate(axis=channel_axis,
        name='mixed2')([branch1x1, branch5x5, branch3x3dbl, branch_pool])
    ...
    x = Concatenate(axis=channel_axis,
        name='mixed3')([branch3x3, branch3x3dbl, branch_pool])
    ...
    x = Concatenate(axis=channel_axis,
        name='mixed4')([branch1x1, branch7x7, branch7x7dbl, branch_pool])
    ...
    for i in range(2):
        ...
        branch_pool = conv2d_bn(branch_pool, 192, 1, 1)
        x = Concatenate( axis=channel_axis,
            name='mixed' + str(5 + i))([branch1x1, branch7x7, branch7x7dbl, branch_pool])
    ...
    branch_pool = conv2d_bn(branch_pool, 192, 1, 1)
    x = Concatenate(  axis=channel_axis,
        name='mixed7')([branch1x1, branch7x7, branch7x7dbl, branch_pool])
